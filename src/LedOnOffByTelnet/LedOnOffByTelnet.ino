    ...
    for(i = 0; i < MAX_SRV_CLIENTS; i++){
      if (serverClients[i] && serverClients[i].connected()){
        if(serverClients[i].available()){
          ...
          int k;
          for (k = 0; serverClients[i].available() && k < 50; k++){
              readData[k] = serverClients[i].read();
          }
          readData[k-1] = NULL;
//          Serial.print("null ptr is in position ");
//          Serial.print(k-1);
//
//            Serial.print("string byte per byte: ");
//            for(int j = 0; j < 50; j++){
//              Serial.write(readData[j]);
//              if(readData[j] == '\n')
//              {
//                String imp = "there's a newline in position ";
//                Serial.println(imp);  
//                Serial.println(j);
//              }
//              if(readData[j] == '\0')
//              {
//                String imp = "there's a nullptr in position ";
//                Serial.println(imp);  
//                Serial.println(j);
//              }
//                
...
//            Serial.println("end of stream.");
            ...
            Serial.print(strcmp(readData,"turn led on"));
            
            if (strcmp(readData,"turn led on") == 0)
              digitalWrite(LED_BUILTIN,HIGH);
           else if (strcmp(readData,"turn led off") == 0)
